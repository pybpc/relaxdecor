...
with open(os.path.join(os.path.dirname(__file__), '..', 'relaxedecor.py')) as file:
    for line in file:
...
context = list()
with open(os.path.join(os.path.dirname(__file__), '..', 'share', 'relaxedecor.rst')) as file:
    for line in file:
...
with open(os.path.join(os.path.dirname(__file__), '..', 'share', 'relaxedecor.rst'), 'w') as file:
    file.writelines(context)
